...
ExecutionFilter <- list(clientId=      0L,
                        ...
                        exchange=      "",
                        side=          "",
                        lastNDays=     NA_integer_,
                        specificDates= integer())
...
ContractDetails <- list(contract=           Contract,
                        ...
                        minAlgoSize=        NA_real_,
                        lastPricePrecision= NA_real_,
                        lastSizePrecision=  NA_real_,
                        secIdList=          character(),
                        cusip=              "",
                        ratings=            "",
                        descAppend=         "",
...
OrderState  <- list(status=               "",
                    ...
                    maintMarginBefore=    NA_real_,
                    equityWithLoanBefore= NA_real_,
                    initMarginChange=     NA_real_,
                    maintMarginChange=    NA_real_,
                    equityWithLoanChange= NA_real_,
                    initMarginAfter=      NA_real_,
                    maintMarginAfter=     NA_real_,
                    equityWithLoanAfter=  NA_real_,
                    commission=           NA_real_,
...
Order <- list(orderId=                        0L,
              ...
              conditionsIncludeOvernight=     FALSE,
              extOperator=                    "",
